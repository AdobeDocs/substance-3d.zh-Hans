---
helpx_url: "https://helpx.adobe.com/cn/substance-3d-integrations/3d-applications/maya/maya-plugin-release-notes/maya-3-0-0-plus.html"
breadcrumb-title: ''
...
* 解决了加载/卸载Maya的Substance增效工具时产生错误屏幕并崩溃的问题。
* 修复了缓存问题，特别是确保.exr文件正确引用，并减少大型场景中与缓存相关的冻结。
* 解决了在Maya增效工具中加载SBSAR文件时没有显示样本窗口中的素材预览的问题。
* 解决了当至少一个SBSAR已在Hypershade中时，连接器无法接收SBSAR文件的问题。
