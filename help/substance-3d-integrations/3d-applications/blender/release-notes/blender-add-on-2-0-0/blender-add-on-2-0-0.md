---
helpx_url: "https://helpx.adobe.com/cn/substance-3d-integrations/3d-applications/blender/release-notes/blender-add-on-2-0-0.html"
breadcrumb-title: ''
...
Substance 3D附加2.0标志着Blender用户的一次革命性更新，其特点是插件体系结构完全重构。 此重新设计的重点是无缝集成、增强的性能以及为未来的扩展提供灵活的基础。 它不仅仅是一种升级，也是对Blender中处理材料方式的重新设想，从而满足3D专业人士不断变化的需求。
...
* [BLD]更改映射的文件类型时材料未更新
* [SRE]始终导出材料的所有映射
* [SRE] Integration Tools使用阶梯导出法线图
* [SRE]Substance加载永不完成
* [SRE]物理尺寸单位未根据场景进行调整
