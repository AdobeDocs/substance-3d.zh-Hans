...
您可以使用3ds Max中的“曲线编辑器”对Substance纹理进行动画制作。
...
1. 向下滚动到您看到漫射图的位置，然后单击+以显示“源图”参数。 此时，您将看到Substance文件中的所有参数。

   ![](../../../assets/3-395.png)
1. 单击要制作动画的参数，然后单击工具栏上的“添加/删除键”按钮。 单击曲线编辑器中的线条以放置关键帧。
