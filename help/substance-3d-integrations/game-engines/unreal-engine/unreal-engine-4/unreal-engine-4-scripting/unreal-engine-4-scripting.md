...
* **引擎安装**： [UE\_4.X.X location]\Engine\Plugins\Marketplace\Substance\Source\SubstanceCore\Classes\SubstanceGraphInstance.h
...
可以通过“窗口”>“开发人员工具”>“输出日志”并将左下方的下拉菜单设置为Python来访问Unreal Engine中的Python编辑器。
