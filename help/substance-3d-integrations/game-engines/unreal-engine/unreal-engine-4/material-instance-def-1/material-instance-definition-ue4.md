...
您现在有一个UE4材料实例，它使用一组特定的Substance纹理。 这是在UE4项目中处理多种物质的一种更优化的方式。 要了解如何使用Blueprint创建MID，请查看此页面。 [蓝图(UE4)：动态素材实例](https://helpx.adobe.com/substance-3d/unlisted/documentation/integrations/blueprint-dynamic-material-instance-152535142.html)
