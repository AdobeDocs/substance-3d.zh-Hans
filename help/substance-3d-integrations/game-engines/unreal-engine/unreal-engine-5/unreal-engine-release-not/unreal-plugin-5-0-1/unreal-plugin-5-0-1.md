...
breadcrumb-title: ''
description: 查看虚构引擎5增效工具版本5.0.1的发行说明，以了解新功能、改进和错误修复。
...
* 支持Unreal引擎版本5.0.0及更高版本
* Unreal引擎5 Plugin文档
* 支持新的三材料模板
* 支持新的“物理尺寸”功能
* *改版* Substance标准模板和Substance折射模板
* 修改世界空间的XYZ值的能力
* Python脚本
* 使用substance输出中的值自动设置物理大小材料节点
...
* 通过蓝图调整材料参数时打包的UE5项目崩溃
* 未选中Substance 图形实例的输出时，插件会关闭参数窗口
* 修正了导致参数更改延迟的偶尔渲染延迟
