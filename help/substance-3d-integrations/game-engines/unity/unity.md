...
>[!WARNING]
>
> 在升级或使用插件之前，请检查[升级项目页面](https://helpx.adobe.com/cn/substance-3d/unlisted/documentation/integrations/upgrading-projects-182256244.html)。
...
* [Unity发行说明](https://helpx.adobe.com/cn/substance-3d/unlisted/documentation/integrations/beta-release-information-170460277.html) - Unity增效工具各版本Substance的新增功能
...
* [在Unity中编写脚本（已弃用）](https://helpx.adobe.com/cn/substance-3d/unlisted/documentation/integrations/scripting-in-unity-170459644.html) — 使用SubstanceAPI，您可以编写脚本以在运行时更新和更改Substance参数。
* [Substance 3D Assets库使用情况](https://helpx.adobe.com/cn/substance-3d/unlisted/documentation/integrations/substance-3d-assets-library-225970070.html)
