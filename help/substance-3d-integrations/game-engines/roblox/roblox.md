...
[Roblox](https://www.roblox.com/)是一个用于沉浸式3D多人体验的平台。 Roblox Studio是Roblox设计工具，它支持“PBR金属粗糙度”工作流程。
...
此图形模板允许预配置最终纹理文件名和类型。 可安装并重新使用此模板来创建始终遵循Roblox素材准则的新素材。
...
在Roblox中，创建一个材质变体并分配从Designer导出的纹理。

* 选择&#x200B;**模型**&#x200B;选项卡，然后单击&#x200B;**材质管理器**
