...
breadcrumb-title: ''
description: 通过使用“按名称匹配”或调整距离来防止网格部件在烘焙过程中彼此渗透。
...
> **说明**
> 
> 烘焙过程从低多边形网格表面发送光线，击中高多边形网格以创建匹配。 有时，光线会射得太远，导致错误的几何形状，从而产生出血和伪影。
...
> * 使用[笼子](https://helpx.adobe.com/substance-3d/unlisted/documentation/bake/cage-projection-172822982.html)限制光线距离。
> * 将常见Baker设置中的默认光线距离更改为较低的值。
