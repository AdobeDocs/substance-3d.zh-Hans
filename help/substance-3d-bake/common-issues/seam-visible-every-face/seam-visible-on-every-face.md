...
> **说明**
> 
> 如果不使用[笼子](https://helpx.adobe.com/substance-3d/unlisted/documentation/bake/cage-projection-172822982.html)，则烘焙过程将沿低多边形网格的顶点法线方向发射光线。 如果每个顶点法线都拆分（即每个脸部与相邻顶点不共享相同的脸部法线），则不会在边缘上以相同的方向发送光线。 这会导致拆分，因为每一边上的信息不同。
> 
...
> 此处只能提供两种解决方案：
> 
> * 使用[笼子](https://helpx.adobe.com/substance-3d/unlisted/documentation/bake/cage-projection-172822982.html)控制光线方向，而不是让Baker从低多边形几何形状计算它。
