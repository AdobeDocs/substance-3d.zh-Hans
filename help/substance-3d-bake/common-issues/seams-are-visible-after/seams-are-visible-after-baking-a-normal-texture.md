...
> * 增加着色器&#x200B;**品质**&#x200B;设置。 着色器品质会影响Specular反射的计算方式。 如果旋转了某些UV 岛，并且该参数太低，则可能产生可见的接缝。 有关详细信息，请参阅[此页面](https://helpx.adobe.com/cn/substance-3d/unlisted/documentation/spdoc/pbr-metal-rough-172818827.html)。
