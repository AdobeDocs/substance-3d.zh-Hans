...
来自Baker的Bent normals计算一个描述环境光照平均方向的纹理。 此Baker派生自网格](../../bakers-settings/ambient-occlusion-from/ambient-occlusion-from-mesh.md)Baker的[Ambient occlusion。
...
| *参数* | *描述* |
| --- | --- |
| **次生射线** | 遮挡射线数量。 较高的值会产生较少的噪声，但计算时间将较长。 |
| **分钟遮挡板距离** | 遮挡射线将到达高多边形几何的最小距离**.** |
| **最大遮挡板距离** | 遮挡射线将到达高多边形几何的最大距离。 |
